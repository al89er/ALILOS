...
- No action-specific skip toggles, mode switch, arbitrary configured-action payload editor, or webapp browser automation in WEB4/PARITY9/PARITY9C/PARITY10B.
- No unattended execution pathway.
...
8. PARITY10B guarded configured-action command execution, disabled by default through local desktop config.
9. PARITY10C deployed field validation before operational reliance.
